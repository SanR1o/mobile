    ...
    const categories = [
      {
        ...
        slug: generateSlug('Electrónicos'),
        color: '#3B82F6',
        icon: '💻',
        sortOrder: 1,
      ...
      },
      {
        ...
        slug: generateSlug('Ropa y Accesorios'),
        color: '#EF4444',
        icon: '👕',
        sortOrder: 2,
        createdBy: adminUser._id
      },
      {
        ...
        slug: generateSlug('Hogar y Jardín'),
        color: '#10B981',
        icon: '🏠',
        sortOrder: 3,
        createdBy: adminUser._id
...
const createSampleSubcategories = async (categories, adminUser) => {
  try {
    ...
    for (const cat of categories) {
      console.log(`Categoría: ${cat.name}, isActive: ${cat.isActive}, ID: ${cat._id}`);
    }
  ...
  try {
    ...
    const products = [
      ...
      },
      {
        ...
        slug: generateSlug('MacBook Air M2'),
        sku: 'MBA13M2001',
        category: categories[0]._id,
      ...
      },
      {
        ...
        slug: generateSlug('Camiseta Básica Algodón'),
        sku: 'CAM001BAS',
        category: categories[1]._id,
